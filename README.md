...
**💫 この情報が他の学生の役に立つと思ったら、ぜひ周りにシェアしてください！**

**🌐 言語 / Languages**: [日本語](README.md) | [English](README.en.md)

**📊 [サービス比較表を見る](COMPARISON.md)** - 音楽、動画、開発ツールなど主要サービスを比較
...
- [ゲーム・エスポーツ](#ゲームエスポーツ)
- [オンライン学習](#オンライン学習)
- [クラウド・ストレージ](#クラウドストレージ)
- [交通・移動](#交通移動)
- [ハードウェア・ショッピング](#ハードウェアショッピング)
...
### Netflix
- 学生専用プランは提供されていないが、一部の大学で特別提供がある場合あり
- **注意**: 公式の学生割引は現在日本では未提供

### Hulu
- 学生割引プランは現在提供されていない
- 一部キャンペーンで学生向け特典がある場合あり
...
### Discord Nitro
- **学生割引**: 一部地域で学生向け特別価格あり
- **対象**: 認定教育機関の学生

### Unity Pro / Unity Student
- **Unity Student**: 学生・教職員向け無料プラン
- **対象**: 認定教育機関の学生・教職員
- **特典**: Unity Pro相当の機能が無料で利用可能

### Unreal Engine
- **基本無料**: すべてのユーザーに無料で提供
- **学生向けリソース**: 学習リソースや教材が充実

### Nintendo Switch Online
- 学生専用の割引はないが、ファミリープランの共有で割安に利用可能

### PlayStation Plus
- 学生専用の割引プランは現在日本では未提供

## 📖 オンライン学習

### Udemy
- **学生割引**: セール時に大幅割引あり
- **特典**: 定期的に開催されるセールで90%オフになることも

### Coursera
- **Coursera for Campus**: 教育機関向けプログラム
- **Financial Aid**: 経済的支援プログラムあり
- **対象**: 条件を満たす学生

### edX
- **Financial Assistance**: 経済的支援プログラムあり
- **対象**: 申請により判定

### Skillshare
- **学生割引**: 年間プランで学生割引あり
- **対象**: 有効な学生メールアドレスを持つ学生
...
### Microsoft OneDrive
- **1TB無料**: Office 365 Education利用者
- **対象**: 教育機関メールアドレスを持つ学生

### Dropbox
- **Dropbox Education**: 学生向けプラン
- **割引**: 通常プランより割安
- **対象**: 有効な学生メールアドレスを持つ学生

### Box
- **Box for Education**: 教育機関向け無料プラン
- **対象**: 提携教育機関の学生

### Amazon Web Services (AWS)
- **AWS Educate**: 学生向けクラウドクレジット
- **特典**: 無料クレジットと学習リソース
- **対象**: 認定教育機関の学生

### Google Cloud Platform (GCP)
- **GCP Education Grants**: 学生向けクレジット
- **特典**: 無料クレジットとトレーニング
- **対象**: 教育機関の学生
...
- **学生・教職員向け**: Mac、iPad、アクセサリが特別価格
- **割引**: 数千円から数万円の割引
- **対象**: 大学生、高等専門学校生、教職員、PTA役員
- **特典**: AppleCare+も割引価格で購入可能

### Microsoft Store Education
- **学生割引**: Surface、アクセサリが割引価格
- **割引**: 最大10%オフ
- **対象**: 学生・教職員
...
### Lenovo 学生ストア
- **学生割引**: ThinkPad、IdeaPad等が特別価格
- **割引**: 通常価格から割引
- **対象**: 学生・教職員

### Adobe Creative Cloud + Surface
- **学生バンドル**: Surfaceと同時購入で割引
- **対象**: 学生
...
- **📅 情報の鮮度**: このリストの情報は随時更新されていますが、必ず公式サイトで最新情報をご確認ください
- **🔐 学生証明**: 学割の申請には学生証明書類（学生証、学校発行メールアドレス等）が必要な場合があります
- **🎓 対象条件**: サービスによって対象となる教育機関や学年が異なります
- **💰 価格変動**: 学割の内容や価格は予告なく変更される場合があります
- **📝 自己確認**: 詳細な条件は各サービスの公式サイトでご確認ください
- **🚫 不正利用禁止**: 学割の不正利用は絶対にやめましょう

### 情報の確認について

このプロジェクトはコミュニティによって維持されており、情報の正確性を保つよう努めていますが、
サービスの内容は頻繁に変更される可能性があります。申請前に必ず公式サイトで最新情報を確認してください。

**情報が古い、または間違っている場合は [Issue](../../issues) でお知らせください！**
...
### 🌐 情報をシェア・拡散
- 🍴 **フォーク & シェア** - 困っている学生に情報を届けてください
- 🐦 **SNSでシェア** - `#学割` `#Awesome学割` で拡散
- 📝 **体験談をシェア** - あなたの学割活用法を教えてください
- 💬 **口コミで広める** - 友人・後輩に直接教えてあげてください
